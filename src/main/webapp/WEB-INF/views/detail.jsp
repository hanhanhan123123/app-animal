...
<body style="margin: 0px">
	...
	<script>
	//실시간 댓글
		const getMessages = function() { //getMessages데이터를 가져와서 갱신
			...
			xhr.onreadystatechange=function(){
				if(this.readyState===4) {
					...
					//map에서 result를 true라고 설정해서 보낸 이유, 트루일때만 하려고
					if(json.result){
	...
	setInterval(function()){; //setInterval 주기적으로 갱신시켜주는 함수. 시계도 만들 수 있음
